...
if (anova_summary[[1]][["Pr(>F)"]][1] < 0.1) {
  print("Istnieje statystycznie istotna różnica w średnim wieku w zależności od poziomu wykształcenia na poziomie 10%.")
} else {
  print("Nie stwierdzono istotnych różnic w średnim wieku w zależności od poziomu wykształcenia.")
}
```
