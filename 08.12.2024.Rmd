...
# 1.3 Sprawdzenie struktury danych 

```{r}
str(sklep_rowerowy)
```

# 1.4 Analiza braków danych 
...
#Zależność pomiędzy posiadaniem roweu a stanem cywilnym
